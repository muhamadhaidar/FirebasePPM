...
const HomeScreen = ({ navigation }: MainTabScreenProps<'Home'>) => {
  ...
  // Memoize header component to prevent unnecessary re-renders of the top section
  ...
  const renderItem = useCallback(({ item }: { item: any }) => (
    ...
    />
  ), [isHabitCompletedToday, handleToggle, handleRemove]);
...
const styles = StyleSheet.create({
  ...
  listContent: { paddingBottom: 100 }, // Added paddingBottom for tab bar space
